...
import buresjak.open.btscout.database.DatabaseHelper
import buresjak.open.btscout.database.MyWorker
import buresjak.open.btscout.database.clearGpsAndLteTables
import buresjak.open.btscout.database.getNumberOfGpsAndLteTables
...
class MainActivity : ComponentActivity() {
    ...
    private fun startWorker() {
        ...
        WorkManager.getInstance(this).enqueueUniqueWork(
            WORK_TAG,
            ExistingWorkPolicy.REPLACE,  // Ensure only one worker runs at a time
            workRequest
        )
    }
